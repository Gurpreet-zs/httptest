...
func TestGetBook(t *testing.T) {
	testcases := []struct {
		...
		{"get all books", "/book", []Book{
			{1, "Gurpreet", Author{Id: 1}, "Penguin", "11/03/2002"},
		}, http.StatusOK},
		{"get all books with query param", "/book?title=Gurpreet", []Book{
			{1, "Gurpreet", Author{Id: 1}, "Penguin", "11/03/2002"}}, http.StatusOK},
		{"get all books with query param", "/book?includeAuthor=true", []Book{
			{1, "Gurpreet", Author{1, "RD", "Sharma", "2/11/1989", "Sharma"}, "Penguin", "11/03/2002"}}, http.StatusOK},
	}
...
func TestGetBookById(t *testing.T) {
	testcases := []struct {
		...
		{"get book", "1", Book{1, "Gurpreet", Author{1, "RD", "Sharma", "2/11/1989", "Sharma"}, "Penguin", "11/03/2002"}, http.StatusOK},
...
func TestPostBook(t *testing.T) {
	testcases := []struct {
		...
		{"Valid Details", Book{Title: "Gurpreet", Author: Author{Id: 1}, Publication: "Penguin", PublishedDate: "11/03/2002"}, Book{1, "Gurpreet", Author{Id: 1}, "Penguin", "11/03/2002"}, 200},
		{"Publication should be Scholastic/Penguin/Arihanth", Book{Title: "Gurpreet", Author: Author{Id: 1}, Publication: "Gurpreet", PublishedDate: "11/03/2002"}, Book{}, http.StatusBadRequest},
		...
		{"Author should exist", Book{Title: "Gurpreet", Author: Author{Id: 2}, Publication: "Penguin", PublishedDate: "11/03/2002"}, Book{}, http.StatusBadRequest},
		{"Title can't be empty", Book{Title: "", Author: Author{Id: 1}, Publication: "", PublishedDate: ""}, Book{}, http.StatusBadRequest},
		{"Book already exists", Book{Title: "Gurpreet", Author: Author{Id: 1}, Publication: "Penguin", PublishedDate: "11/03/2002"}, Book{}, http.StatusBadRequest},
	}
	for i, tc := range testcases {
		w := httptest.NewRecorder()
